...
const ActionsOverview = () => {
    ...
    const paginateActionsCollection = useCallback(
        () => paginate(actionsCollection?.docs, PAGE_SIZE, pageQuery),
        [actionsCollection, pageQuery],
    );
        ...
        <>
            <div className="flex min-h-full flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-4xl">
                    ...
                    {!actionsLoading &&
                        !topicsLoading &&
                        ((actionsCollection?.docs?.length ?? 0) > 0 ? (
                            <>
                                ...
                                <Pagination totalCount={totalActions} pageSize={PAGE_SIZE} />
                            </>
                        ) : (
