...
const TopicHeader = () => {
    ...
    const [headerShadowOpacity, setHeaderShadowOpacity] = useState(
        currentCategory?.imageTextShadowOpacity ?? HEADER_SHADOW_OPACITY_BEFORE_IMAGE_LOAD,
    );
    ...
    if (isHomePage(currentCategory, currentLocation)) {
        pageTitle = DEFAULT_PAGE_TITLE;
    } else if (currentCategory?.id && currentLocation?.id) {
        pageTitle = `${currentCategory?.category} in ${currentLocation?.location}`;
    }
                ...
                >
                    ...
                    <div className="block">
                        ...
                        >
                            {!!currentCategory?.id &&
                                !!currentLocation?.id &&
                                tabsToDisplay.map((tab, tabIdx, tabArr) => (
                                    <Link
                                        key={tab.value}
